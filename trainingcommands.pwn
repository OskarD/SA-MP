...
Check for ,C ,s ,i ,f ,b ,G ,S ," in functions (Give space)
Check for for(new i; i < MAX_PLAYERS
Check for +, - and * without space

Configure threaded queries

Move server version to main

Re-write teleports and cars systems
...
Buggat:
FIXED: /fixveh - Default GetPlayerVehicleID & string size "Vehicle fixed"
FIXED: /gethere - (0/1) inte [0/1]
FIXED: /gotocar - usage hela tiden
FIXED: /despawnall - tar inte alla bilar
FIXED: /givegun - ger inget, crash vid sträng
FIXED: /deletecar - usage säger /delete
FIXED: /markp - felvänt 0 & 1
